...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { Patient_id: @prescription.Patient_id, comments: @prescription.comments, end_date: @prescription.end_date, prescribed_insulin: @prescription.prescribed_insulin, prescribed_on: @prescription.prescribed_on, start_date: @prescription.start_date } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { Patient_id: @prescription.Patient_id, comments: @prescription.comments, end_date: @prescription.end_date, prescribed_insulin: @prescription.prescribed_insulin, prescribed_on: @prescription.prescribed_on, start_date: @prescription.start_date } }
